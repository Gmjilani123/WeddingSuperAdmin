...
import { getAllFast2SmsCredentialD, updateFast2SmsCredentialD } from '../../../../api/Api';
...
function FastCredential() {
  ...
  const handleSubmitData = async (e) => {
    ...
    try {
      setLoading(true)
      const res = await updateFast2SmsCredentialD(payloadData);
  ...
  const getData = async () => {
    try {
      setLoading(true)
      const res = await getAllFast2SmsCredentialD();
        ...
        <div className="card-body">
          <form className="form-horizontal" onSubmit={handleSubmitData}>
            ...
            <div className="form-group row">
              ...
              <div className="col-lg-8">
                <input type="text" className="form-control" value={inputVal?.auth_key}
                  onChange={handleChange} name="auth_key"  placeholder="AUTH KEY" required />
              </div>
            </div>
            ...
            <div className="form-group row">
              ...
              <div className="col-lg-8">
                <input type="text" className="form-control" value={inputVal?.entity_id}
                  onChange={handleChange} name="entity_id" placeholder="ENTITY ID" />
              </div>
            </div>
            ...
            <div className="form-group row">
              ...
              <div className='col-lg-8'>
                <Form.Select className="dropdown form-control aiz-" name='route' value={inputVal?.route}
            ...
            <div className="form-group row">
              ...
              <div className="col-lg-8">
                <Form.Select className="dropdown form-control aiz-" name='lang' value={inputVal?.lang}
                  onChange={handleChange}>
            ...
            <div className="form-group row">
              ...
              <div className="col-lg-8">
                <input type="text" className="form-control" value={inputVal?.sender_id}
                  onChange={handleChange} name="sender_id"  placeholder="6 digit SENDER ID" />
              </div>
            </div>
