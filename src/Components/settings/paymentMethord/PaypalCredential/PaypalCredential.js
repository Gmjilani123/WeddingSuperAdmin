...
import { getPaypalCredentialsD, updatePaypalCredentialsD } from "../../../../api/Api";
...
function PayPalCredential() {
  ...
  const handleSubmitData = async (e) => {
    ...
    try {
      setLoading(true)
      const res = await updatePaypalCredentialsD(payloadData);
  ...
  const getData = async () => {
    try {
      setLoading(true)
      const res = await getPaypalCredentialsD();
