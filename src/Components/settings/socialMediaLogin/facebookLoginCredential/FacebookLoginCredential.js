...
import { getAllFacebookLoginD, updateFacebookD } from "../../../../api/Api";
...
function FacebookLoginCredential () {
  ...
  const handleSubmitData = async (e) => {
    ...
    try {
      setLoading(true)
      const res = await updateFacebookD(payloadData);
  ...
  const getData = async () => {
    try {
      setLoading(true)
      const res = await getAllFacebookLoginD();
      console.log("getAllFacebookLoginres---", res);
